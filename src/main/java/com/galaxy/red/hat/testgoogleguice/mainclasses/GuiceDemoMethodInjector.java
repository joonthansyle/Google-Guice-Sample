...
import com.galaxy.red.hat.testgoogleguice.request.SquareRequestMethodInjector;
import com.google.inject.Guice;
import com.google.inject.Injector;

public class GuiceDemoMethodInjector {
    ...
    private static void sendRequest(String squareReq){
        if(squareReq.equals(SQUARE_REQ)){
            ...
            SquareRequestMethodInjector request = injector.getInstance(SquareRequestMethodInjector.class);
            request.makeRequest();
        }
    }
